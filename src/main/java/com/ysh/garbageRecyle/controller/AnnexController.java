...
public class AnnexController {
    ...
    public Object save(@RequestBody AnnexEntity entity) {
    ...
    public Object updateById(@PathVariable("id") Integer id, @RequestBody AnnexEntity entity){
    	 entity.setAnnexId(id);
