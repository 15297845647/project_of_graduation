...
public class ApiTest {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
        //云市场分配的密钥Id
        String secretId = "AKIDN1O8Lwyt16jnYKdacE5IXG9DMf19Ekf0Y4z4";
        //云市场分配的密钥Key
        String secretKey = "f71nF7q7e9I2pneGDpUGCx6RiDiul18GkjR1g9Ha";
        ...
        queryParams.put("needAllList", "是");
        queryParams.put("needContent", "");
        queryParams.put("page", "10");
        queryParams.put("title", "垃圾分类");
        // body参数
